...
public class BookTypeServiceImpl implements BookTypeService {
	...
	@Override
	public boolean addBookType(int bookId, int typeId) {
		boolean valid = true;
		LOGGER.info("Begin addBookType with bookId: " + bookId + " and typeId: " + typeId);
		...
		LOGGER.info("End addBookType with bookType: " + booktype);
		return valid;
	}
